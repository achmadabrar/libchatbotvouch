package vouch.sg.vouchsgchatbot
...
import vouch.sg.vouchsgchatbot.adapter.ChatBotAdapter
...
class ChatActivity : AppCompatActivity() {
    ...
    var chatBoxAdapter: ChatBotAdapter? = null
            ...
            override fun call(vararg args: Any) {
                try {
                    ...
                    runOnUiThread {
                        ...
                        MessageList.add(m)
                        chatBoxAdapter = ChatBotAdapter(MessageList)
