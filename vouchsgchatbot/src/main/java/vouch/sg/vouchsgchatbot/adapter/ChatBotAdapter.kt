package vouch.sg.vouchsgchatbot.adapter
...
import vouch.sg.vouchsgchatbot.R
import vouch.sg.vouchsgchatbot.models.Message

class ChatBotAdapter(private val dataPelangganDua:ArrayList<Message>): RecyclerView.Adapter<ChatBotAdapter.ViewHolder>() {
